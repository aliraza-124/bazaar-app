    ...
    <Card>
      <Box sx={classess.styledMainBox}>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          ...
          <Typography sx={classess.styledPrice}>${totalAmount}</Typography>
        </Box>

        <Box display="flex" alignItems="Center" mt={4} mb={1}>
          <Typography mr={1} sx={classess.styledHeadings}>
            Additional Comments
          </Typography>
        ...
        <Box>
          <TextField multiline rows={4} fullWidth color="error" />
          ...
          <Button
            variant="outlined"
            fullWidth
            sx={{ ...classess.styledButton, marginTop: "16px" }}
          >
            Apply Voucher
          </Button>
        </Box>
        ...
        <Box mt={4} mb={1}>
          <Typography mb={1} sx={classess.styledHeadings}>
            Shipping Estimates
          </Typography>
          ...
          <Button
            variant="contained"
            fullWidth
            sx={{ ...classess.styledCheckoutButton, marginTop: "16px" }}
          >
            Checkout Now
          </Button>
        </Box>
